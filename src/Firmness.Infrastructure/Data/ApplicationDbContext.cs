...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser>, IUnitOfWork
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Vehicle>(b =>
        {
            ...
            b.Property(v => v.CurrentHours).HasColumnType("decimal(18,0)");
            b.Property(v => v.CurrentMileage).HasColumnType("decimal(18,0)");
            b.Property(v => v.Specifications).HasMaxLength(2000);
            b.Property(v => v.SerialNumber).HasMaxLength(100);
            b.Property(v => v.MaintenanceHoursInterval).HasColumnType("decimal(18,0)");
        ...
        modelBuilder.Entity<VehicleRental>(b =>
        {
            ...
            b.Property(vr => vr.InitialHours).HasColumnType("decimal(18,0)");
            b.Property(vr => vr.FinalHours).HasColumnType("decimal(18,0)");
            b.Property(vr => vr.InitialMileage).HasColumnType("decimal(18,0)");
            b.Property(vr => vr.FinalMileage).HasColumnType("decimal(18,0)");
